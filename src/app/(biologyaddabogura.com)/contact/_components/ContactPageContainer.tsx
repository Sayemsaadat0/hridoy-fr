...
const ContactPageContainer = () => {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      {/* Section 2: Office Locations with Maps */}
      ...
      {/* Section 3: Contact Form and Details */}
      <section className="relative py-10 lg:py-16">
        <div className="hr-container relative z-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      onChange={handleChange}
                      rows={6}
                      className="w-full bg-hr-black/50 border-hr-white/20 text-hr-white placeholder:text-hr-gray focus:border-hr-green-toxic focus:ring-hr-green-toxic/20 resize-none transition-all"
                      placeholder="DETAILS"
                    />
                  </div>
